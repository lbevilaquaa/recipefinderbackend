  ...
  const recipes = [
    {
      ...
      cover: "recipes/quinoa-veggie-bowl.webp",
      servings: 2,
      prepMinutes: 10,
      cookMinutes: 15,
      ingredients: [
      ...
      instructions: [
        { description: "Cook quinoa according to package, fluff and cool slightly.", order: 1 },
        { description: "In bowls layer spinach, quinoa, sweet potato and chickpeas.", order: 2 },
        { description: "Top with avocado slices and pumpkin seeds.", order: 3 },
        { description: "Whisk olive oil, lemon juice, salt & pepper; drizzle over bowls.", order: 4 },
      ],
    },
    {
      ...
      cover: "recipes/salmon-asparagus.webp",
      servings: 2,
      prepMinutes: 5,
      cookMinutes: 12,
      ingredients: [
      ...
      instructions: [
        { description: "Heat a large skillet over medium-high with olive oil.", order: 1 },
        { description: "Season salmon and asparagus with salt, pepper, and minced garlic.", order: 2 },
        { description: "Place salmon skin-side down; arrange asparagus around.", order: 3 },
        { description: "Cook 4 min, flip salmon, add lemon slices, cook 4-5 min more until salmon is opaque.", order: 4 },
    ...
    },
    {
      ...
      cover: "recipes/mediterranean-chickpea-salad.webp",
      servings: 2,
      prepMinutes: 10,
      cookMinutes: 0,
      ingredients: [
      ...
      instructions: [
        { description: "In a large bowl combine chickpeas, cucumber, tomatoes, bell pepper, red onion and parsley.", order: 1 },
    ...
    },
    {
      ...
      summary: "Layers of creamy yogurt, fresh berries and crunchy oats for a high-protein snack.",
      cover: "recipes/greek-yogurt.webp",
      servings: 1,
      prepMinutes: 5,
      cookMinutes: 0,
      ingredients: [
      ...
      instructions: [
        { description: "In a glass, layer half the yogurt, berries and oats.", order: 1 },
    ...
    },
    {
      ...
      cover: "recipes/banana-pancakes.webp",
      servings: 2,
      prepMinutes: 5,
      cookMinutes: 10,
      ingredients: [
      ...
      instructions: [
        { description: "Blend bananas, oats, eggs, baking powder and cinnamon until smooth.", order: 1 },
        { description: "Heat lightly oiled skillet on medium; pour 1/4-cup batter circles.", order: 2 },
    ...
    },
    {
      ...
      cover: "recipes/lentil-soup.webp",
      servings: 4,
      prepMinutes: 10,
      cookMinutes: 20,
      ingredients: [
      ...
      instructions: [
        { description: "Heat oil in a pot; sauté onion, carrot, celery 4 min.", order: 1 },
        { description: "Add garlic & cumin; cook 1 min.", order: 2 },
        { description: "Stir in lentils, tomatoes and broth; bring to boil.", order: 3 },
        { description: "Simmer 15 min until lentils tender.", order: 4 },
        { description: "Stir in spinach until wilted, season and serve.", order: 5 },
      ],
    },
    {
      ...
      cover: "recipes/sweet-potato-tacos.webp",
      servings: 3,
      prepMinutes: 10,
      cookMinutes: 15,
      ingredients: [
      ...
      instructions: [
        { description: "Toss sweet potato cubes with oil, cumin, paprika, salt; roast in air-fryer or oven at 200 °C for 12 min.", order: 1 },
        { description: "Warm tortillas in a dry skillet.", order: 2 },
        { description: "Fill tortillas with roasted sweet potatoes, black beans and cabbage.", order: 3 },
        { description: "Squeeze lime juice, add salsa and cilantro.", order: 4 },
      ],
    },
    {
      slug: "avocado-tomato-wholegrain-toast",
      title: "Avocado & Tomato Wholegrain Toast",
      summary: "Creamy avocado spread over toasted wholegrain bread, topped with juicy tomatoes.",
      cover: "recipes/avocado-tomato-wholegrain-toast.webp",
      servings: 1,
      prepMinutes: 5,
      cookMinutes: 5,
      ingredients: [
      ...
      instructions: [
        ...
        { description: "Mash avocado with lemon juice, salt and pepper.", order: 2 },
        { description: "Spread avocado on toast and top with tomatoes.", order: 3 },
        { description: "Drizzle olive oil and sprinkle chili flakes.", order: 4 },
      ],
    },
  ];
